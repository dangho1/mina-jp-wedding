...
function RSVP() {
    ...
    async function submitRSVP() {
        const doc = new GoogleSpreadsheet("1CsxH9fSPNTSDoTclRgbYhVR-x3uv-jEiE3eokPI88cQ");
        try {
            ...
            await sheet.addRow({Förnamn: firstName, Efternamn: surName, email: email});
  ...
  <button type="submit" class="btn btn-primary" onClick={checkRSVP}>Anmäl</button>
</form>
